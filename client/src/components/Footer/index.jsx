...
const Footer = () => {
    return (
        <div className='w-full mt-24 bg-gradient-to-r from-[#4da8f3] to-[#163d69] text-white py-y px-2'>
        ...
        <p className='py-4'>2024 Tammy, Kunal, Morgan LLC. All rights reserved</p>
